...
set wrap
" linebreaks (to not chop words) for pdf and txt and md and latex
autocmd BufRead,BufNewFile *.pdf,*.txt,*.md,*.tex setlocal wrap linebreak nolist
" spell checker for txt and md and latex
autocmd BufRead,BufNewFile *.txt,*.md,*.tex setlocal spell
" no spell checker for CMakeLists though (this overrides the above autocmd)
...
set updatetime=100
" higher update time for latex files improves preview
autocmd BufRead,BufNewFile,BufEnter *.tex setlocal updatetime=5000
