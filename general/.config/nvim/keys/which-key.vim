...
let g:which_key_map['h'] = [ '<C-W>s | :Startify'                              , 'split below']
...
let g:which_key_map['v'] = [ '<C-W>v | :Startify'                              , 'split right']
...
let g:which_key_map.b = {
      ...
      \ '?' : ['Buffers'                , 'fzf-buffer'],
      \ 't' : [':tablast | :tabnew'     , 'new tab'],
      \ 'x' : [':call DeleteEmptyBuffers() | :call DeleteHiddenBuffers()'     , 'delete hidden buffers'],
      \ }
